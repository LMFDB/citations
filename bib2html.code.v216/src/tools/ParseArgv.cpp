...
static char rcsid[] = "$Header: /udd/fspindle/robot/cvsroot/bib2html/src/tools/ParseArgv.cpp,v 1.1.1.1 2007/01/19 11:12:31 marchand Exp $ SPRITE (Berkeley)";
 *
...
#ifdef HP
int ParseArgv (argcPtr, argv, argTable, flags)
...
#endif
{
   register ArgvInfo *infoPtr;	/* Pointer to the current entry in the
