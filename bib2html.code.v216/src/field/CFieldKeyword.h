...
*/
#ifndef __CFieldKeyword_h_
#define __CFieldKeyword_h_
...
class CFieldKeyword : public CField
{
 ...
 public:
  ...
  CFieldKeyword( CFieldKeyword& f) ;
  CFieldKeyword& operator=( CFieldKeyword &f) ;

  CList<string> LKeyword ;
  
  CFieldKeyword(string &s) ;
